//Global variables
let token = "7371426698:AAEcdheMbH_s8OjXkIWzO3WrhCgIoYoaOMk";  //bot token
let chatId = "751089651"; //bot chat id
let sheet = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/18hiWeKB1Y7S9mUidpLffpf8tcLR87dbfeynMRgZieBI/edit?resourcekey#gid=818098608"); //sheet where you want to store data

let webAppUrl = "https://script.google.com/macros/s/AKfycbxkPin_9Xi1Qz48Nx-yv-jnZutjfbPd8qskNS6r0XRC75M26kPX57d7WKNr6Nmdj2tv/exec"; //Google script url
...
function deleteText(messageId) {
  var url = "https://api.telegram.org/bot" + token + "/deleteMessage?chat_id="+chatId+"&message_id=" + String(messageId);
  var response = UrlFetchApp.fetch(url);
  Logger.log(response);
}
