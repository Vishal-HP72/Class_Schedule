//Global variables
let botToken = "7371426698:AAEcdheMbH_s8OjXkIWzO3WrhCgIoYoaOMk"; //bot token
let chatId = "751089651"; //bot chat id

let form = FormApp.openById('1x0EB4vxhktnPYo3T6aEH264bcDKHtRc6yhOca8_sZ48'); // Form ID
let sheet = SpreadsheetApp.openByUrl('https://docs.google.com/spreadsheets/d/18hiWeKB1Y7S9mUidpLffpf8tcLR87dbfeynMRgZieBI/edit?resourcekey#gid=818098608'); //Spreadsheet of Form
...
function onFormSubmit(event) {
  ...
  ending_note += "\nNOTE 2 : Usually it may take up to 12-24 hours for approval of your request, if it is emergency please contact Mohit Kumar 7973610713 " ; 
  ending_note += "\n\nIn your service, \nSankhya Team 😇" ; 
